...
public class ISW2SchemaC4LLMTest {
  ...
  public void recordFieldsReceivePositionsAndSupportLookup() {
    ...
    Schema record = Schema.createRecord("Item", null, "example", false, Arrays.asList(first, second));
  ...
  public void fieldExposesMetadataDefaultOrderAndAliases() {
    Schema.Field field = new Schema.Field("count", Schema.create(Schema.Type.INT), "number of items",
        Integer.valueOf(7), Schema.Field.Order.DESCENDING);
  ...
  public void enumExposesSymbolsOrdinalsMembershipAndDefault() {
    Schema schema = Schema.createEnum("Color", "colors", "example", Arrays.asList("RED", "GREEN", "BLUE"), "GREEN");
