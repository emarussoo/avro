...
public class TimeConversions {
  ...
  public static class TimeMillisConversion extends Conversion<LocalTime> {
    ...
    public String adjustAndSetValue(String varName, String valParamName) {
      return varName + ASSIGNMENT_OPERATOR + valParamName + ".truncatedTo(java.time.temporal.ChronoUnit.MILLIS);";
    }
  ...
  public static class TimeMicrosConversion extends Conversion<LocalTime> {
    ...
    @Override
    public String adjustAndSetValue(String varName, String valParamName) {
      return varName + ASSIGNMENT_OPERATOR + valParamName + ".truncatedTo(java.time.temporal.ChronoUnit.MICROS);";
    }
  ...
  public static class TimestampNanosConversion extends Conversion<Instant> {
    ...
    @Override
    public String adjustAndSetValue(String varName, String valParamName) {
      return varName + ASSIGNMENT_OPERATOR + valParamName + ".truncatedTo(java.time.temporal.ChronoUnit.NANOS);";
    }
