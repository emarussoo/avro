...
public class ISW2SchemaC4RNDErrorTest0 {
    ...
    public void test1() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "ISW2SchemaC4RNDErrorTest0.test1");
    ...
    public void test2() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "ISW2SchemaC4RNDErrorTest0.test2");
    ...
    public void test3() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "ISW2SchemaC4RNDErrorTest0.test3");
