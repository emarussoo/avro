...
public class ISW2SchemaLLMTest {
  ...
  public void primitiveTypesHaveExpectedTypeAndName() {
    Type[] primitiveTypes = {
        Type.STRING, Type.BYTES, Type.INT, Type.LONG,
  ...
  public void recordMetadataAndFieldsAreExposedInPositionOrder() {
    ...
    Schema record = Schema.createRecord(
        "User", "user record", "example.model", false, Arrays.asList(id, active));
  ...
  public void aFieldCannotBeReusedByAnotherRecord() {
    ...
    Schema first = Schema.createRecord(
        "First", null, "example", false, Collections.singletonList(shared));
    assertSame(shared, first.getField("value"));

    try {
      Schema.createRecord(
          "Second", null, "example", false, Collections.singletonList(shared));
  ...
  public void fieldExposesDefaultOrderDocumentationAndAliases() {
    Field field = new Field(
        "count", Schema.create(Type.INT), "number of items", Integer.valueOf(7),
  ...
  public void explicitNullDefaultIsDistinctFromNoDefault() {
    ...
    Field explicit = new Field(
        "explicit", Schema.create(Type.NULL), null, Field.NULL_DEFAULT_VALUE);
  ...
  public void enumExposesSymbolsOrdinalsAndDefault() {
    ...
    Schema schema = Schema.createEnum(
        "Color", "available colors", "example", symbols, "GREEN");
  ...
  public void enumRejectsDefaultOutsideSymbolSet() {
    try {
      Schema.createEnum(
          "E", null, "example", Arrays.asList("A", "B"), "C");
  ...
  public void enumOrdinalRejectsUnknownSymbol() {
    Schema schema = Schema.createEnum(
        "E", null, "example", Arrays.asList("A", "B"));
  ...
  public void unionPreservesBranchOrderAndSupportsNameLookup() {
    ...
    Schema record = Schema.createRecord(
        "Entry", null, "example", false, Collections.<Field>emptyList());
  ...
  public void nullableRecognizesNullAndNestedContainerCases() {
    ...
    Schema arrayOfNullable = Schema.createArray(
        Schema.createUnion(stringSchema, nullSchema));
  ...
  public void fixedSchemaExposesNameAliasesAndSize() {
    ...
    assertEquals(
        new java.util.LinkedHashSet<String>(
            Arrays.asList("example.LegacyToken", "legacy.ExternalToken")),
        fixed.getAliases());
  }
  ...
  public void qualifiedNameOverridesSeparateNamespaceArgument() {
    Schema record = Schema.createRecord(
        "actual.space.Item", null, "ignored.space", false,
  ...
  public void applyAliasesRewritesRecordAndFieldNames() {
    Schema writer = Schema.createRecord(
        "OldRecord", null, "example", false,
        Collections.singletonList(
            new Field("oldField", Schema.create(Type.STRING))));

    Field readerField = new Field("newField", Schema.create(Type.STRING));
    readerField.addAlias("oldField");
    Schema reader = Schema.createRecord(
        "NewRecord", null, "example", false,
